...
- **Welcome tour settings**: turn the tour on and edit its steps.

## What you can do

- Turn the welcome tour on.
- Edit the steps new admins see.
- Restart the tour for a user.

## Where to find it

Go to **Welcome tour** in the admin settings.
